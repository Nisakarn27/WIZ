...
$(function(){
	//PRELOAD IMAGES
	var images = [
		'../~/Scripts/images/parisbg.jpg',
		'../~/Scripts/images/logo-intro.png',
		'../~/Scripts/images/icon-facebook.png',
		'../~/Scripts/images/icon-twitter.png',
		'../~/Scripts/images/icon-gplus.png',
		'../~/Scripts/images/icon-youtube.png',
		'../~/Scripts/images/select.png',
		'../~/Scripts/images/test.jpg',
		'../~/Scripts/images/test2.jpg',
		'../~/Scripts/images/test3.jpg',
		'../~/Scripts/images/test4.jpg',
		'../~/Scripts/images/test5.jpg'
	];
						...
						function StartAnimation() {
							...
							if ($screenwidth >= 768){
								setTimeout(function (){
									...
									$('.full-vacations').css({'opacity': 1,'left': -220 +'px'});			
									$('.leaf').css({'opacity': 1,'left': -220 +'px'});	
									$('.b1,.b2,.b3,.b4,.b5').css({'opacity': 0});	

									$('.full-flight').css({'opacity': 0,'left': -400 +'px'});		
									$('.full-hotel').css({'opacity': 0,'left': -220 +'px'});	
									$('.dubai').css({'opacity': 0,'left': -200 +'px'});	
									$('.plane').css({'opacity': 0,'left': -100 +'px'});		
									$('.dubai').css({'opacity': 0,'left': -200 +'px'});	
									$('.full-car').css({'opacity': 0,'left': -420 +'px'});					
									$('.road').css({'opacity': 0,'right': -400 +'px'});			
									$('.car').css({'opacity': 0,'left': -45 +'%'});	
									$('.full-cruise').css({'opacity': 0,'left': -420 +'px'});					
									...
									//couple & bg animation
									setTimeout(function (){
										var $cw = $('.full-vacations').width();
										$('.full-vacations').animate({'opacity': 1,'left': -$cw/5.6 +'px'},{ duration: 4000, queue: false });
...
function changeAnimation1(){
	$('.full-flight').animate({'opacity': 0,'left': -400 +'px'});		
	$('.full-hotel').animate({'opacity': 0,'left': -220 +'px'});	
	$('.full-car').animate({'opacity': 0,'left': -420 +'px'});					
	$('.full-cruise').animate({'opacity': 0,'left': -420 +'px'});					
	
	var $cw = $('.full-vacations').width();
	$('.full-vacations').animate({'opacity': 1,'left': -$cw/5.6 +'px'});			
	}	
function changeAnimation2(){
	$('.full-vacations').animate({'opacity': 0,'left': -220 +'px'});			
	$('.full-flight').animate({'opacity': 0,'left': -400 +'px'});	
	$('.full-car').animate({'opacity': 0,'left': -420 +'px'});					
	$('.full-cruise').animate({'opacity': 0,'left': -420 +'px'});					
	
	var $gg2w = $('.full-hotel').width();
	$('.full-hotel').animate({'opacity': 1,'left': 0 +'px'});		
}	
function changeAnimation3(){
	...
	$('.full-car').animate({'opacity': 0,'left': -420 +'px'});					
	$('.full-cruise').animate({'opacity': 0,'left': -420 +'px'});					
	var $ggw = $('.full-flight').width();
	$('.full-flight').animate({'opacity': 1,'left': -$ggw/4.6 +'px'});						
}	
function changeAnimation4(){
	...
	var $gc2w = $('.full-car').width();
	$('.full-car').animate({'opacity': 1,'left': -$gc2w/3.2 +'px'});	
}			
function changeAnimation5(){
	...
	var $gcw = $('.full-cruise').width();
	$('.full-cruise').animate({'opacity': 1,'left': -$gcw/4.9 +'px'});						
}	
